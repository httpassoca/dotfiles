...
osascript -e 'tell application "Notion Calendar" to activate'
...
osascript -e 'tell application "Music"' -e 'play (POSIX file "/Users/passoca/atoa/runaway-note.mp3")' -e 'end tell' -e 'delay 2'
